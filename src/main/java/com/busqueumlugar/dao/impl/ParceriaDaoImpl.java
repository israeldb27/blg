...
@Repository
public class ParceriaDaoImpl extends GenericDAOImpl<Parceria, Long>  implements ParceriaDao {
	
	private static final Logger log = LoggerFactory.getLogger(ParceriaDaoImpl.class);
	...
	public ParceriaDaoImpl() {
		super(Parceria.class);
	}
	
	
	@Override
	public Parceria findParceriaById(Long id) {
		Criteria crit = session().createCriteria(Parceria.class);
		crit.add(Restrictions.eq("id", id));
		return (Parceria)crit.uniqueResult();		
	}

	@Override
	public List<Parceria> findParceriaByIdImovel(Long idImovel) {
		Criteria crit = session().createCriteria(Parceria.class);
	...
	@Override
	public List<Parceria> findParceriaByIdImovelByStatus(Long idImovel, String status) {
		Criteria crit = session().createCriteria(Parceria.class);
		crit.createCriteria("imovel").add(Restrictions.eq("id", idImovel));
	...
	@Override
	public List<Parceria> findParceriaByIdUsuarioSolicitanteByStatus(Long idUsuarioSolicitante, String status, ParceriaForm form) {		
		Criteria crit = session().createCriteria(Parceria.class);
	...
	@Override
	public List<Parceria> findParceriaByIdDonoImovelByStatus(Long idDonoImovel, String status, ParceriaForm form) {
		Criteria crit = session().createCriteria(Parceria.class);
	...
	@Override
	public Parceria findParceriaByIdUsuarioSolicitanteByIdImovel(Long idUsuario, Long idImovel) {
		Criteria crit = session().createCriteria(Parceria.class);
	...
	@Override
	public List checarImoveisComMaisSolParceriaPeriodo(AdministracaoForm form) {
	...
	@Override
	public List findParceriaBySolAceitasDistintas( Long idUsuario, String status, ParceriaForm form) {
	...
	@Override
	public List<Imovel> findParceriaAceitosPorUsuarioSolicitantePorPerfil(Long idPerfil, String status, PerfilForm form) {
	...
	@Override
	public Parceria findLastImovelParceriaMeusImoveisByIdImovel(Long idImovel) {		
		Criteria crit = session().createCriteria(Parceria.class);
		crit.createCriteria("imovel").add(Restrictions.eq("id", idImovel));
	...
	@Override
	public List<Parceria> findAllParceriaByIdUsuarioByStatus(	Long idUsuario, String status) {
		...
		LogicalExpression orExp = Restrictions.or(critUsuarioDonoImovel, critUsuarioSolicitante);
		crit.add(orExp);		          
        return (List<Parceria>)crit.list();
	}

	@Override
	public List<Parceria> filterSolParceria(Long idDonoImovel, ParceriaForm form) {
	...
	@Override
	public List<Parceria> filterMinhasSolParceria(Long idUsuarioSolicitante, ParceriaForm form) {
	...
	@Override
	public List<Parceria> filterParceriaAceitas(Long idDonoImovel, ParceriaForm form) {
	...
	@Override
	public List findParceriasByStatusByIdUsuarioDistinct(Long idUsuarioSessao, String status, ParceriaForm form) {
		Criteria crit = session().createCriteria(Parceria.class);
		ProjectionList projList = Projections.projectionList();
		projList.add(Projections.groupProperty("imovel.id"));
		projList.add(Projections.count("imovel.id").as("quant"));
	...
	@Override
	public List filterFindParceriaByStatusByIdUsuarioDistinct(Long idUsuario, String status, ParceriaForm form) {
	...
	@Override
	public int findQuantidadeNovosParcerias(Long idImovel) {
	...
	@Override
	public List findParceriasSolicitacoesRecebidasByStatusByIdUsuarioDistinct(Long idUsuarioSessao, String status, ParceriaForm form) {
		Criteria crit = session().createCriteria(Parceria.class);
		ProjectionList projList = Projections.projectionList();
		projList.add(Projections.groupProperty("imovel.id"));
		projList.add(Projections.count("imovel.id").as("quant"));
	...
	@Override
	public List filterFindParceriaSolicitacoesRecebidasByStatusByIdUsuarioDistinct(Long idUsuario, String status, ParceriaForm form) {
	...
	@Override
	public List findParceriasMinhasSolicitacoesByStatusByIdUsuarioDistinct(Long idUsuarioSessao, String status, ParceriaForm form) {
		Criteria crit = session().createCriteria(Parceria.class);
		ProjectionList projList = Projections.projectionList();
		projList.add(Projections.groupProperty("imovel.id"));
		projList.add(Projections.count("imovel.id").as("quant"));
	...
	@Override
	public List filterFindParceriaMinhasSolicitacoesByStatusByIdUsuarioDistinct(Long idUsuario, String status, ParceriaForm form) {
	...
	@Override
	public List findUsuariosImoveisCompartilhadosByStatusByIdUsuario(Long idUsuarioSessao, String status, ParceriaForm form) {
		
		Criteria crit1 = session().createCriteria(Parceria.class);
		...
		Criteria crit2 = session().createCriteria(Parceria.class);
		...
		if (! StringUtils.isNullOrEmpty(form.getOpcaoOrdenacao()) ||
		   ...
		   (! StringUtils.isNullOrEmpty(form.getOpcaoPerfilContatoAgruparUsuarios())))) {
			...
			Criteria critUsuario2 = crit2.createCriteria("usuarioSolicitante");
			if (! StringUtils.isNullOrEmpty(form.getOpcaoContatoAgruparUsuarios()) && 
			   (! form.getOpcaoContatoAgruparUsuarios().equals(TipoContatoOpcaoEnum.TODOS_USUARIOS.getRotulo())) ){		
				List listaIds = null;
				if (form.getOpcaoContatoAgruparUsuarios().equals(TipoContatoOpcaoEnum.MEUS_CONTATOS.getRotulo())){
	...
	@Override
	public List findUsuariosParceriaByStatusByIdDonoImovel(Long idUsuarioSessao, String status, ParceriaForm form) {
		Criteria crit = session().createCriteria(Parceria.class);
		ProjectionList projList = Projections.projectionList();				
	...
	@Override
	public List<Parceria> findParceriasByIdUsuarioByIdUsuario2(Long idUsuario, Long idUsuario2) {
		Criteria crit = session().createCriteria(Parceria.class);		
		crit.createCriteria("usuarioDonoImovel").add(Restrictions.eq("id", idUsuario));
	...
	@Override
	public long findQuantidadeParceriaPorUsuarioPorStatus(Long idUsuario, String status) {
		Criteria crit = session().createCriteria(Parceria.class);
		Criterion critUsuarioDonoImovel 	   = Restrictions.eq("usuarioDonoImovel.id", idUsuario);
		Criterion critUsuarioSolicitante 	   = Restrictions.eq("usuarioSolicitante.id", idUsuario); 
		LogicalExpression orExp = Restrictions.or(critUsuarioDonoImovel, critUsuarioSolicitante);
	...
	@Override
	public long checarQuantidadeParceriaSolRecebidaByDonoImovelByStatusByStatusLeitura(Long idDonoImovel, 
	...
	@Override
	public long findQuantParceriaByIdImovelByStatus(Long idImovel, String status) {
		Criteria crit = session().createCriteria(Parceria.class);		
		crit.createCriteria("imovel").add(Restrictions.eq("id", idImovel));
		crit.add(Restrictions.eq("status", status));		
		ProjectionList projList = Projections.projectionList();		
