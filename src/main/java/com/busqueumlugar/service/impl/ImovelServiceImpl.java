...
public class ImovelServiceImpl implements ImovelService{
	...
	public List<Usuario> pesquisarPossiveisCompradores(Long idUsuario, ImovelForm form) {		
		...
		// Recuperar usu�rios que lan�aram propostas para im�veis
		List listaIdsUsuariosImoveisProposta = imovelPropostasDao.findUsuariosImoveisProposta(idUsuario, form);
		
		// Recuperar usu�rios que lan�aram propostas para im�veis que s�o semelhantes a este 
