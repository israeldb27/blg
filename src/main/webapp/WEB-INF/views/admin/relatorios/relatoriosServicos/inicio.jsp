        ...
        <section id="wrapper">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-pencil"></i> <spring:message code="lbl.admin.link.relatorios.servicos"/> </h2>                                                      
                </div><!-- /.header-content -->
                <!--/ End header content -->
                        ...
                        <div class="col-md-12">                        		
                            ...
                            <div class="panel rounded shadow">
                                ...
                                <div class="panel-body no-padding">
                                    <form:form class="form-horizontal mt-12" method="POST" id="administracaoForm" modelAttribute="administracaoForm" action="${urlAdmin}/selecionarRelatorioServicos" >
                                      <div class="form-body">
                                        	...
                                        	<div class="form-group">   
		                                        ...
		                                        <div class="col-sm-7">
		                                            <form:select id="relatorioSelecionado" path="relatorioSelecionado" class="form-control">                                
														...
														<form:option value="totalServicos"><spring:message code="lbl.admin.opcao.rel.total.servicos"/></form:option>
														<form:option value="volFinanceiroServicos"><spring:message code="lbl.admin.opcao.rel.vol.total.servicos"/></form:option>
														<form:option value="usuariosVolFinancServicos"><spring:message code="lbl.admin.opcao.rel.usuario.vol.total.servicos"/></form:option>														
									                </form:select>
