					                                        ...
					                                        <table class="table table-default">
					                                            ...
					                                            <tr>
																	...
																	<c:if test="${administracaoForm.tipoRelatorio == 'acessoUsuario'}">
																		<th><spring:message code="lbl.relatorios.col.total.acessos"/></th>
																	</c:if>
																	<c:if test="${administracaoForm.tipoRelatorio == 'quantUsuariosxServicos'}">
																		<spring:message code="lbl.admin.rel.title.total.usuarios.servicos"/>
																	</c:if>
																	<c:if test="${administracaoForm.tipoRelatorio == 'ultimoAcessoUsuarioPeriodo'}">
																		<th> </th>
																		<th><spring:message code="lbl.relatorios.col.usuario"/></th>
																		<th><spring:message code="lbl.relatorios.col.perfil.usuario"/></th>					                                                
																		<th><spring:message code="lbl.relatorios.col.data.ulti.acesso.usuario"/></th>
																	</c:if>
					                                            </tr>
					                                            </thead>
					                                            <tbody>
																	...
																	<c:if test="${administracaoForm.tipoRelatorio == 'ultimoAcessoUsuarioPeriodo'}">
																		<c:forEach var="usuario" items="${administracaoForm.listaUsuarios}" varStatus="item">
																			<tr class="border-primary">					                                                
																				...
																				<td><fmt:formatDate value='${usuario.dataUltimoAcesso}' pattern='dd/MM/yyyy'/></td>					                                                					                                               
																			</tr>					                                  
																		</c:forEach>
																	</c:if>
					                                            </tbody>
