        ...
        <section id="wrapper">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-pencil"></i> <spring:message code="lbl.admin.link.relatorios.usuarios"/> </h2>                                                      
                </div><!-- /.header-content -->
                <!--/ End header content -->
                        ...
                        <div class="col-md-12">                        		
                            ...
                            <div class="panel rounded shadow">
                                ...
                                <div class="panel-body no-padding">
                                    <form:form class="form-horizontal mt-12" method="POST" id="administracaoForm" modelAttribute="administracaoForm" action="${urlAdmin}/selecionarRelatorioUsuarios" >
                                      <div class="form-body">
                                        	...
                                        	<div class="form-group">   
		                                        ...
		                                        <div class="col-sm-7">
		                                            <form:select id="relatorioSelecionado" path="relatorioSelecionado" class="form-control">                                
														...
														<form:option value="quantTotal"><spring:message code="lbl.admin.opcao.rel.total.usuarios"/></form:option>
														<form:option value="acessoUsuario"><spring:message code="lbl.admin.opcao.rel.total.acessos.periodo"/></form:option>														
														<form:option value="ultimoAcessoUsuarioPeriodo"><spring:message code="lbl.admin.opcao.rel.acesso.usuarios.periodo"/></form:option>
