                        ...
                        <div class="col-md-12">                        		
                            ...
                            <div class="panel rounded shadow">
                                ...
                                <div class="panel-body no-padding">
                                    <form:form class="form-horizontal mt-12" method="POST" id="administracaoForm" modelAttribute="administracaoForm" action="${urlAdmin}/selecionarRelatorioAssinaturas" >
                                      <div class="form-body">
                                        	...
                                        	<div class="form-group">   
		                                        ...
		                                        <div class="col-sm-7">
		                                            <form:select id="relatorioSelecionado" path="relatorioSelecionado" class="form-control">                                
														...
														<form:option value="totalAssinaturas"><spring:message code="lbl.admin.opcao.rel.total.assinaturas"/></form:option>
														<form:option value="assinaturasVolFinanceiro"><spring:message code="lbl.admin.opcao.rel.tipo.assinaturas.vol.financeiro"/></form:option>
														<form:option value="buscaAssinaturasUsuario"><spring:message code="lbl.admin.opcao.rel.busca.assinaturas.usuario"/></form:option>														
									                </form:select>									                 
