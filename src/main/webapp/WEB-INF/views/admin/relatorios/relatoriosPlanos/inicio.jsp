        ...
        <section id="wrapper">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-pencil"></i> <spring:message code="lbl.admin.link.relatorios.planos"/> </h2>                                                      
                </div><!-- /.header-content -->
                <!--/ End header content -->
                        ...
                        <div class="col-md-12">                        		
                            ...
                            <div class="panel rounded shadow">
                                ...
                                <div class="panel-body no-padding">
                                    <form:form class="form-horizontal mt-12" method="POST" id="administracaoForm" modelAttribute="administracaoForm" action="${urlAdmin}/selecionarRelatorioPlanos" >
                                      <div class="form-body">
                                        	...
                                        	<div class="form-group">   
		                                        ...
		                                        <div class="col-sm-7">
		                                            <form:select id="relatorioSelecionado" path="relatorioSelecionado" class="form-control">                                
														...
														<form:option value="totalPlano"><spring:message code="lbl.admin.opcao.rel.total.planos"/></form:option>
														<form:option value="planosVolFinanceiro"><spring:message code="lbl.admin.opcao.rel.tipo.plano.vol.financeiro"/></form:option>
														<form:option value="buscaPlanoUsuario"><spring:message code="lbl.admin.opcao.rel.busca.planos.usuario"/></form:option>																												
									                </form:select>
