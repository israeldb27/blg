                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel rounded shadow">
                                <div class="panel-heading">
                                    <div class="pull-left">  
                                        <h3 class="panel-title"><spring:message code="lbl.title.link.mensagens.cobranca.servico"/> <code></code></h3>
                                    </div>
                                ...
                                <div class="panel-body no-padding">                                   
										<div class="callout callout-info mb-20">												
			                                <p><spring:message code="lbl.mensagem.aviso.cobranca.servico"/></p>
			                            </div>
                                </div><!-- /.panel-body -->
                            </div><!-- /.panel -->
                            <!--/ End inline form -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel rounded shadow">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h3 class="panel-title"><spring:message code="lbl.mensagem.title.selecao.servico"/></h3>
                                    </div><!-- /.pull-left -->
                                    <div class="pull-right">
                                        <button class="btn btn-sm" data-action="collapse" data-container="body" data-toggle="tooltip" data-placement="top" data-title="Collapse"><i class="fa fa-angle-up"></i></button>
                                    </div><!-- /.pull-right -->                                    
                                ...
                                <div class="panel-body no-padding">                                    
                                    <form:form class="form-horizontal mt-10" method="POST" id="mensagemForm" modelAttribute="mensagemForm" action="${urlMensagem}/selecionarMensagemCobranca" >
                                      <div class="form-body">
		                                        <div class="form-group"> 
			                                        <label for="idInfoServicoPagamentoSelecionada" class="col-sm-4 control-label"><spring:message code="lbl.mensagem.valores.disponiveis"/>:</label>
			                                        <div class="col-sm-7">
			                                            <form:select id="idInfoServicoPagamentoSelecionada" path="idInfoServicoPagamentoSelecionada" class="form-control">                                
															...
															<form:options items="${mensagemForm.listaInfoServicoPagamento}" itemValue="id" itemLabel="labelDuracao"/>
													  </form:select>
	                                            ...
	                                            <div class="form-group">
			                                        ...
			                                        <div class="col-sm-7">
			                                            <form:select id="idFormapagamentoSelecionada" path="idFormapagamentoSelecionada" class="form-control">                                
															<form:option value="-1" ><spring:message code="opcao.selecao.uma.opcao"/></form:option>
															<form:options items="${mensagemForm.listaOpcoesFormaPagamento}" itemValue="id" itemLabel="label"/>
													  </form:select>
	                                       		...
	                                       		<div class="form-group">
		                                            ...
		                                            <div class="col-sm-7">
		                                            	<br>
		                                            	<button type="submit" class="btn btn-primary btn-block" style="width: 40%;"><spring:message code="lbl.btn.selecionar.geral"/></button>                                            	
		                                            </div>   
	                                            </div>  
