                        ...
                        <div class="col-md-12">                        		
                            ...
                            <div class="panel rounded shadow">
                                <div class="panel-heading">
                                    <div class="pull-left"> 
                                        <h3 class="panel-title"><spring:message code="lbl.selecao.pagto.plano"/></h3>
                                    </div><!-- /.pull-left -->
                                ...
                                <div class="panel-body no-padding">
                                    <form:form class="form-horizontal mt-10" method="POST" id="servicoForm" modelAttribute="servicoForm" action="${urlServico}/confirmarPagtoPlanoPayPal" >
                                    <form:hidden path="id" />
                                      <div class="form-body">
