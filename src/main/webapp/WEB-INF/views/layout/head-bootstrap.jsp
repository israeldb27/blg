...
<c:set var="context" value="<%= request.getContextPath()%>"/>  
   ...
   <!-- START JAVASCRIPT SECTION (Load javascripts at bottom to reduce load time) -->
        ...
        <script src="${context}/js/carregarTimeline.js"></script>
        <script src="${context}/js/formatar.js"></script>                 
        ...
        <script src="${context}/assets/commercial/plugins/cube-portfolio/cubeportfolio/js/jquery.cubeportfolio.min.js"></script>
        <script src="${context}/assets/admin/js/pages/blankon.form.advanced.js"></script>
        <script src="${context}/assets/admin/js/pages/blankon.timeline.js"></script>
        <script src="${context}/assets/admin/js/pages/blankon.timeline.type2.js"></script>
      ...
      <script src="${context}/js/bootstrap-datepicker.pt-BR.js"></script>
