...
$(window).load(function() {
	 ...
	 var listaRelatorio = ${relatorioImobiliaria};	 
	 var dataArray = null;	
	 if ( listaRelatorio.length > 0 ){
		 
		 if ( menuItem == 'imobiliariaMaisIntermediacoesAceitas') {			 
	     	 dataArray = [['Imobiliaria', 'Quantidade']];  
		   	 $.each(listaRelatorio, function (index, table) {  
		   	        dataArray.push([table.nome, table.quantCompartilhamentoAceitos]);  
		   	 });
		 }
		 else if ( menuItem == 'imobiliariasMaisParceriasAceitas') {			 
	     	 dataArray = [['Imobiliaria', 'Quantidade']];  
		   	 $.each(listaRelatorio, function (index, table) {  
		   	        dataArray.push([table.nome, table.quantCompartilhamentoAceitos]);  
		   	 });
                                    ...
                                    <div class="panel-body col-md-9">
                                        <form action="#" class="tab-content form-horizontal">
                                            ...
                                            <div class="tab-pane fade in active" id="tab2-2">
	                                                ...
	                                                <div class="form-group">
	                                                    	<div class="table-responsive" style="margin-top: -1px;">
						                                        <table class="table table-default">
																	...
																	<c:choose>
																		<c:when test="${(menu == 'imobiliariaMaisIntermediacoesAceitas')}">
																			<c:forEach var="usuarioRelatorio" items="${imobiliariaMaisIntermediacoesAceitas}" varStatus="item">
																		...
																		<c:when test="${(menu == 'imobiliariasMaisParceriasAceitas')}">
																			<c:forEach var="usuarioRelatorio" items="${imobiliariasMaisParceriasAceitas}" varStatus="item">
																				<tr class="border-primary">					                                                
																					<td>						                                                    
																						<a href="${urlUsuario}/detalhesUsuario/${usuarioRelatorio.id}"><img src="${context}/${usuarioRelatorio.imagemArquivo}" style="width: 100px; height: 80px; " /></a> 
																					</td>						                                                
                                            	...
                                            	<c:if test="${ ((empty imobiliariaMaisIntermediacoesAceitas) && (empty imobiliariasMaisParceriasAceitas)) }">
				                            		<div class="form-group">
                                                    	<div class="table-responsive" style="margin-top: -1px;">
