                        ...
                        <div class="col-md-12">
                            <div class="panel rounded shadow">
                                ...
                                <div class="panel-body no-padding">
                                    ...
                                    <form:form method="POST" class="form-horizontal mt-10" id="relatorioForm" modelAttribute="relatorioForm" action="${urlRelatorio}/confirmarPagamentoRelatorioPayPal" >
                                      <div class="form-body">
                                        <div class="form-group"> 
		                                        <label for="idInfoServicoPagamentoSelecionada" class="col-sm-4 control-label"><spring:message code="lbl.relatorio.valor.servico"/>:</label>
		                                        <div class="col-sm-7">											  
												 	<fmt:formatNumber value="${relatorioForm.valorServico}" pattern="#,##0.00;-0"/>					         
                                               </div>             
                                       </div>
                                       <div class="form-group">
                                            <label for="idFormapagamentoSelecionada" class="col-sm-4 control-label"><spring:message code="lbl.relatorio.duracao.servico"/>:</label>
	                                        <div class="col-sm-7">
												    ${relatorioForm.tempoDuracao} 
                                            </div>
                                       </div>
                                       
                                       <div class="form-group">
                                            <label class="col-sm-4 control-label"><spring:message code="lbl.relatorio.forma.pagamento"/>:</label>
	                                        <div class="col-sm-7">
												    ${relatorioForm.formaPagtoSelecionado} 
                                            </div>
                                       </div>
