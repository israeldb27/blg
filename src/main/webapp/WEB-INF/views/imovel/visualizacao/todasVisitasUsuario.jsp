...
<script type="text/javascript">
	...
	function mostrarModal(id){	
		if (id == 0){
			$('#msgModal').html("<spring:message code='lbl.modal.desc.aba.todas.visualizacoes.usuario'/>");		
			$('#msgModalFuncionalidade').html("<spring:message code='lbl.aba.todas.visualizacoes.usuario'/>");
		}
		else if (id == 1){
			$('#msgModal').html("<spring:message code='lbl.modal.desc.aba.todas.visualizacoes.usuario'/>");		
			$('#msgModalFuncionalidade').html("<spring:message code='lbl.aba.todas.minhas.visualizacoes.usuario'/>");
		}
		                                ...
		                                <div class="inner-all">
		                                    <ul class="list-unstyled">
		                                        ...
		                                        <li class="text-center">
		                                            ...
		                                            <p class="text-muted text-capitalize">  ${usuarioVisitante.perfilFmt} </p>
		                                        </li>
		                                        ...
		                                        <ul class="nav nav-tabs">
		                                            <li class="active">
		                                                <a href="#tab4-1" data-toggle="tab">
		                                                    ...
		                                                    <div>
		                                                        <span class="text-strong"><spring:message code="lbl.todas.visualizacoes.info.imovel"/></span>                                                        
		                                                    </div>
		                                                </a>
		                                            </li>
		                                        ...
		                                        <div class="tab-content">
		                                            <div class="tab-pane fade in active" id="tab4-1">
		                                            	 ...
		                                            	 <div class="form-group">
		                                                		<strong class="col-sm-3"> <spring:message code="lbl.data.cadastro.usuario"/> </strong> <fmt:formatDate value='${usuarioVisitante.dataCadastro}' pattern='dd/MM/yyyy'/>
		                                            	 </div><!-- /.form-group -->
		                                            
		                                            	 <div class="line"></div>
		                                            	 
		                                            	 <div class="form-group">
		                                                		<strong class="col-sm-3"><spring:message code="lbl.estado"/></strong> ${usuarioVisitante.estado}
		                                            	 </div><!-- /.form-group -->
		                                            	 
		                                            	 <div class="line"></div>
		                                            	 
		                                            	 <div class="form-group">
		                                                		<strong class="col-sm-3"><spring:message code="lbl.cidade"/></strong> ${usuarioVisitante.cidade}
		                                            	 </div><!-- /.form-group -->
		                                            	 
		                                            	 <div class="line"></div>		                                            	 							                             
							                             
							                             <div class="form-group">
		                                                		<strong class="col-sm-3"><spring:message code="lbl.bairro"/></strong> ${usuarioVisitante.bairro}
		                                            	 </div><!-- /.form-group -->
		                                ...
		                                <div class="panel-heading">
		                                	<c:choose>
		                                		<c:when test="${imovelvisualizadoForm.tipoLista == 'meusImoveisVisitados'}">
		                                			 <div class="pull-left">	
		                                					<h3 class="panel-title"><spring:message code="lbl.aba.todas.visualizacoes.usuario"/></h3>
		                                		...
		                                		<c:when test="${imovelvisualizadoForm.tipoLista == 'imoveisVisitados'}">
		                                			  <div class="pull-left">	
		                                					<h3 class="panel-title"><spring:message code="lbl.aba.todas.minhas.visualizacoes.usuario"/></h3>
		                                        			&nbsp;&nbsp;<label style="font-size: 12px; font-style: italic;"><strong> <spring:message code="lbl.quant.total.imoveis"/> </strong>: (${quantTotalImoveis}) </label>
		                                			 </div>
		                                			 <div class="pull-right">
		                                    ...
		                                    <div class="table-responsive" style="margin-top: -1px;">
		                                        <table class="table table-striped">
		                                            ...
		                                            <tr>		                                                
		                                                ...
		                                                <th class="text-center"><spring:message code="lbl.data.visualizacao"/></th>  
		                                            </tr>
		                                            </thead>
		                                            <tbody>
