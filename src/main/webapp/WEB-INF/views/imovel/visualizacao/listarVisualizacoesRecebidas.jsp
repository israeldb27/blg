	                                            ...
	                                            <div class="media-left">
	                                                <a href="${urlImovel}/detalhesImovel/${imovelVisualiza.imovel.id}" >
	                                                   <span class="meta-provider" style="font-size:19px;">${imovelVisualiza.imovel.acaoFmt} <br>
	                                                    ...
	                                                    <img src="data:image/jpeg;base64,${imovelVisualiza.imovel.imagemArquivo}" class="img-responsive" style="width: 260px; height: 240px; alt="admin"/>
	                                                </a>
	                                            </div>
	                                            <div class="media-body">
	                                                <span class="label pull-right" style="background-color: #9d2428; font-size: 12px">${imovelVisualiza.imovel.tipoImovelFmt}</span>
	                                                <h4 class="media-heading" style="margin-bottom:20px;"><a href="${urlImovel}/detalhesImovel/${imovelVisualiza.imovel.id}" style="color : #9d2428;">${imovelVisualiza.imovel.titulo}</a></h4>
	                                                ...
	                                                <div class="col-md-5" >                                                    
	                                                 	...
	                                                 	<div class="media-body" >
				                                            ...
				                                            <a href="${urlUsuario}/detalhesUsuario/${imovelVisualiza.usuario.id}">
				                                            	<img src="data:image/jpeg;base64,${imovelVisualiza.usuario.imagemArquivo}" class="img-responsive" style="width: 60px; height: 65px; alt="admin"/>
				                                            </a>
	                                                    ...
	                                                    <table class="table table-condensed">
	                                                        <tbody style="font-size: 13px;">
	                                                            ...
	                                                            <tr>
	                                                                ...
	                                                                <td class="text-right">${imovelVisualiza.imovel.quantGaragem} <spring:message code="lbl.num.vagas"/></td>
	                                                            </tr>
	                                                        </tbody>
	                                                    </table>
