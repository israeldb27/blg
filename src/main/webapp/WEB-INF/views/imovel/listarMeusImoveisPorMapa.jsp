        ...
        <section id="wrapper">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-pencil"></i> <spring:message code="lbl.title.link.meus.imoveis.mapa"/> </h2>	 
                </div><!-- /.header-content -->
                <!--/ End header content -->
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-4">
                            ...
                            <form:form method="POST" id="imovelForm" modelAttribute="imovelForm" action="${urlImovel}/buscarImovelMapa" >
                        		...
                        		<c:when test="${not empty listaImoveisMapa }">
	                                ...
	                                <div class="pull-right" style="padding-right:10px;">
	                                	<spring:message code="lbl.hint.imovel.lista.imoveis" var="hintListaImoveis"/>
                                         <form:form method="POST" id="imovelBuscarImoveiForm" modelAttribute="imovelForm" action="${urlImovel}/filtrarMeusImoveis" >
