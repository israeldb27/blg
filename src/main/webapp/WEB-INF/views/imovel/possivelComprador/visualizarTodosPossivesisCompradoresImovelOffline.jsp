...
<script type="text/javascript">
	...
	function mostrarModal(id){	
		if (id == 0){
			$('#msgModal').html("<spring:message code='lbl.aba.modal.desc.lista.todos.possiveis.compradores.offline'/>");		
			$('#msgModalFuncionalidade').html("<spring:message code='lbl.lista.todos.possiveis.compradores.offline'/>");
		}
        ...
        <section id="wrapper">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-pencil"></i><spring:message code="lbl.title.aba.det.imovel.possivel.comprador.offline"/> </h2>     
                </div><!-- /.header-content -->                
                   			...
                   			<div class="col-lg-9 col-md-9 col-sm-8">
			                    ...
			                    <div class="divider"></div>	
	                      	   ...
	                      	   <div class="row">
		                      		<div class="panel">
		                      			<c:choose>
											<c:when test="${not empty listaPossivelCompradorOffline}">
				                                ...
				                                <div class="panel-body no-padding">
				                                    <div class="table-responsive" style="margin-top: -1px;">
				                                        <table class="table table-striped" >
					                                         ...
					                                         <tbody>
					                                            <c:forEach var="comprador" items="${listaPossivelCompradorOffline}">
					                                               <tr>
											...
											<c:when test="${empty listaPossivelCompradorOffline}">
