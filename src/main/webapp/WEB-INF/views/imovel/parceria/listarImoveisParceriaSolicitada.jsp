            ...
            <section id="page-content">
                ...
                <div class="header-content">
                     <h2><i class="fa fa-pencil"></i> 
                     	<spring:message code="lbl.title.link.parcerias"/> <span><spring:message code="lbl.title.link.solicitacoes.recebidas"/></span>
                      </h2>  
                </div><!-- /.header-content -->
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <div class="row">                  		 
					    ...
					    <div class="col-lg-9 col-md-9 col-sm-8">
					    	<c:choose>
					    		<c:when test="${ empty listaParceriaSolRecebida }">
				    			    <div class="callout callout-warning">
	                                    <strong><spring:message code="lbl.nenhuma.parceria"/></strong>                              
	                                </div>
					    		</c:when>
					    		
					    		<c:when test="${ not empty listaParceriaSolRecebida }">
	                                ...
	                                <div class="media-list list-search">
	                                 		<c:forEach var="imovelParceria" items="${listaParceriaSolRecebida}" varStatus="item">
