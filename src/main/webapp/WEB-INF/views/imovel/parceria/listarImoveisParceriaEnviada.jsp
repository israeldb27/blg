            ...
            <section id="page-content">
                ...
                <div class="header-content">
                     <h2><i class="fa fa-pencil"></i> 
                     	<spring:message code="lbl.title.link.parcerias"/> <span><spring:message code="lbl.title.link.solicitacoes.enviadas"/></span>
                      </h2>
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <div class="row">                  		 
					    ...
					    <div class="col-lg-9 col-md-9 col-sm-8">
					    	<c:choose>
					    		<c:when test="${ empty listaParceriaMinhasSol }">
					    			<div class="callout callout-warning">
	                                    <strong><spring:message code="lbl.nenhuma.intermediacao"/></strong>                              
	                                </div>
					    		</c:when>
					    		
					    		<c:when test="${not empty listaParceriaMinhasSol }">
	                                ...
	                                <div class="media-list list-search">
	                                 		<c:forEach var="imovelParceria" items="${listaParceriaMinhasSol}" varStatus="item">
	                                        <div class="media rounded shadow no-overflow">
	                                            <div class="media-left">
	                                                <a href="${urlImovel}/detalhesImovel/${imovelParceria.imovel.id}" >
	                                                   <span class="meta-provider" style="font-size:19px;">${imovelParceria.imovel.acaoFmt} <br>
	                                                    ...
	                                                    <img src="${context}${imovelParceria.imovel.imagemArquivo}" class="img-responsive" style="width: 260px; height: 195px; alt="admin"/>
	                                                </a>
	                                            </div>
	                                            <div class="media-body">
	                                                <span class="label pull-right" style="background-color: #03A9F4; font-size: 12px">${imovelParceria.imovel.tipoImovelFmt}</span>
	                                                <h4 class="media-heading" style="margin-bottom:20px;"><a href="${urlImovel}/detalhesImovel/${imovelParceria.imovel.id}" style="color : #03A9F4;">${imovelParceria.imovel.titulo}</a></h4>
	                                                ...
	                                                <div class="col-md-7">
	                                                    ...
	                                                    <br>         
	                                                 	...
	                                                 	<% if ( request.getSession().getAttribute("acessoValido").equals("S") ) {%>                                                 			
	                                                 			...
	                                                 			<a href="#" onClick="prepararModalConfirmaExclusao(${imovelParceria.id})" style="font-size:x-large; color: rgb(99, 110, 123);"  class="dropdown-toggle" ><i class="fa fa-times"> <font style="color: rgb(99, 110, 123); font-size: 12px; margin-bottom:  22px;"> ${mensagemExcluirSolicitacao} </font> &nbsp;&nbsp; </i> </a>                                                 			 
				                                        <% } %>
			 ...
			 <!-- Start optional size modal element - confirmacao exclusao parceria enviada -->
            <div id="idModalConfirmacaoExclusaoParam" class="modal fade bs-example-modal-lg-confirmacao-exclusao-sol-parceria" tabindex="-1" role="dialog" aria-hidden="true">
