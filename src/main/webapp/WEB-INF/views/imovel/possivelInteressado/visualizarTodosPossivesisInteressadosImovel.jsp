...
<script type="text/javascript">
	...
	function mostrarModal(id){	
		if (id == 0){
			$('#msgModal').html("<spring:message code='lbl.aba.modal.desc.lista.todos.possiveis.interessados'/>");		
			$('#msgModalFuncionalidade').html("<spring:message code='lbl.lista.todos.possiveis.interessados'/>");
		}
        ...
        <section id="wrapper">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-pencil"></i><spring:message code="lbl.title.aba.det.imovel.possivel.interessado"/> </h2>     
                </div><!-- /.header-content -->                
                   			...
                   			<div class="col-lg-9 col-md-9 col-sm-8">
			                    ...
			                    <div class="divider"></div>	
	                      	   ...
	                      	   <div class="row">
		                      		<div class="panel">
		                      			<c:choose>
											<c:when test="${not empty listaPossivelInteressado}">
				                                ...
				                                <div class="panel-body no-padding">
				                                    <div class="table-responsive" style="margin-top: -1px;">
				                                        <table class="table table-striped" >
					                                         ...
					                                         <tbody>
					                                            <c:forEach var="interesado" items="${listaPossivelInteressado}">
					                                               <tr>
					                                               	  <td style="font-size: 13px;" class="text-center"> <small><fmt:formatDate value='${interesado.dataCadastro}' pattern='dd/MM/yyyy'/></small> </td>	
					                                               	  <td style="font-size: 13px;" class="text-center">${interesado.usuarioInteressado.nome} </td>
					                                                  <td style="font-size: 13px;" class="text-center"><small> ${interesado.chanceInteresseFmt} </small></td>		                                               
					                                                  <td style="font-size: 13px;" class="text-center"><small> ${interesado.observacao} </small></td>
					                                                   <td class="text-center" >
					                                                     <a href="#a" onClick="prepararModalConfirmaEdicaoPossivelCompr('${interesado.id}', '${interesado.usuarioInteressado.nome}', '${interesado.chanceInteresse}','${interesado.observacao}');" ><i class="fa fa-pencil-square-o"></i></a>
					                                                  </td>		                                                  
					                                                  <td class="text-center" >
					                                                     <a href="#a" onClick="prepararModalConfirmaExclusaoPossivelInteressado(${interesado.id});" ><i class="fa fa-trash-o"></i></a>
					                                                  </td>
					                                               </tr>
					                                            </c:forEach>
					                                         </tbody>
											...
											<c:when test="${empty listaPossivelInteressado}">
