...
<script type="text/javascript">
    	...
    	function confirmarExclusaoEnviadaIntermediacao(){	
    		...
    		$.ajax({
    				 url: '${urlImovelCompartilhado}/confirmarExclusaoEnviadaIntermediacao/' + parametro.value,			 
    				 success: function(){				 
    					 location.reload();     	    
    				 },
    				 error: function(jqXHR, textStatus, errorThrown) {				 
					    		...
					    		<c:when test="${ not empty listarIntermediacaoMinhasSol }">
	                                ...
	                                <div class="pull-right" style="padding-right:10px; width: 240px;">
	                                		<spring:message code="lbl.hint.tipo.ordenacao" var="hintOrdenar"/>
	                                    		<form:form method="POST" id="intermediacaoMinhasSolForm" modelAttribute="intermediacaoForm" action="${urlImovelCompartilhado}/ordenarIntermediacao" >
