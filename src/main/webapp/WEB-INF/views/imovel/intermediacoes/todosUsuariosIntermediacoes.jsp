...
<script type="text/javascript">
	...
	function mostrarModal(id){	
		if (id == 0){
			$('#msgModal').html("<spring:message code='lbl.aba.desc.modal.todos.usuarios.intermediacao'/>");		
			$('#msgModalFuncionalidade').html("<spring:message code='lbl.aba.todos.usuarios.intermediacao'/>");
		}
