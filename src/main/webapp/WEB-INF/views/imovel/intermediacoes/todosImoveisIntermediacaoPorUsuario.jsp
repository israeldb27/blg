		                                ...
		                                <div class="inner-all">
		                                    <ul class="list-unstyled">
		                                        ...
		                                        <li class="text-center">
		                                            ...
		                                            <p class="text-muted text-capitalize">  ${usuarioIntermediacao.perfilFmt}  </p>
		                                        </li>
		                                        ...
		                                        <div class="tab-content">
		                                            <div class="tab-pane fade in active" id="tab4-1">
		                                            	 ...
		                                            	 <div class="form-group">
		                                                	<strong class="col-sm-3"> <spring:message code="lbl.data.cadastro.usuario"/> </strong> <fmt:formatDate value='${usuarioIntermediacao.dataCadastro}' pattern='dd/MM/yyyy'/>
		                                            	 </div><!-- /.form-group -->
		                                            
		                                            	 <div class="line"></div>
		                                            	 
		                                            	 <div class="form-group">
		                                                	<strong class="col-sm-3"><spring:message code="lbl.estado"/></strong> ${usuarioIntermediacao.estado}
		                                            	 </div><!-- /.form-group -->
		                                            	 
		                                            	 <div class="line"></div>
		                                            	 
		                                            	 <div class="form-group">
		                                                	<strong class="col-sm-3"><spring:message code="lbl.cidade"/></strong> ${usuarioIntermediacao.cidade}
		                                            	 </div><!-- /.form-group -->
		                                            	 
		                                            	 <div class="line"></div>		                                            	 							                             
							                             
							                             <div class="form-group">
		                                                	<strong class="col-sm-3"><spring:message code="lbl.bairro"/></strong> ${usuarioIntermediacao.bairro}
		                                            	 </div><!-- /.form-group -->		                                            	  
		                                            </div>                          
		                                        </div>                                       
		                                    </div><!-- /.panel-body -->
	                      	   ...
	                      	   <div class="row">
		                      		<div class="panel">
		                                <div class="panel-heading">
		                                    <div class="pull-left">
		                                        <h3 class="panel-title"><spring:message code="lbl.aba.todos.imoveis.intermediacao.por.usuario"/></h3>
