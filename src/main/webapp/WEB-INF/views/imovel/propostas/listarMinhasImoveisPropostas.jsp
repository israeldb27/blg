...
function confirmarExclusaoParametro(){	
	...
	$.ajax({
			 url: '${urlImovelPropostas}/confirmarExclusaoMinhaProposta/' + parametro.value,			 
			 success: function(){				 
				 location.reload();     	    
			 },
			 error: function(jqXHR, textStatus, errorThrown) {				 
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <div class="row">                  		 
					    ...
					    <div class="col-lg-9 col-md-9 col-sm-8">
					    	<c:choose>
					    		<c:when test="${ empty listaPropostasLancadas }">
					    			<div class="callout callout-warning">
	                                    <strong><spring:message code="msg.nenhuma.proposta.lancada"/></strong>                              
	                                </div>
					    		</c:when>
					    		
					    		<c:when test="${not empty listaPropostasLancadas }">
	                                ...
	                                <div class="pull-right" >
	                                	<spring:message code="lbl.hint.tipo.agrupar" var="hintAgrupar"/>
	                                       	<form:form method="POST" id="modoVisualizarPropostasLancadasForm" modelAttribute="imovelPropostaForm" action="${urlImovelPropostas}/modoVisualizar" >
												<form:hidden path="tipoLista" value="propostasLancadas"/>
												<form:select id="opcaoVisualizacaoPropostasLancadas" path="opcaoVisualizacao" class="form-control" title="${hintAgrupar}">                                
	                                ...
	                                <div class="pull-right" style="padding-right:10px;">
	                                	<spring:message code="lbl.hint.tipo.ordenacao" var="hintOrdenar"/>
	                                   	<form:form method="POST" id="propostasLancadasForm" modelAttribute="imovelPropostaForm" action="${urlImovelPropostas}/ordenar" >
						              		  	<form:hidden path="tipoFiltro" value="propostasLancadas"/>								               
								                        	<form:select id="opcaoOrdenacaoLancadas" path="opcaoOrdenacao" class="form-control" title="${hintOrdenar}">                                
																 ...
																 <form:option value="menorValorProposta" ><spring:message code="lbl.opcao.ordenacao.imovel.maior.valor.proposta"/></form:option>
										                  </form:select>
								               </form:form>
	                                </div><!-- /.pull-left -->
	                                ...
	                                <c:if test="${imovelPropostaForm.isVisible() }">
	                                	<div class="pull-right" style="padding-right:20px;">
		                                    <form:form method="POST" id="propostasLancadasPageForm" modelAttribute="imovelPropostaForm" action="${urlImovelPropostas}/paginarFiltrar" >
	                                ...
	                                <div class="media-list list-search">
	                                 		<c:forEach var="imovelProposta" items="${listaPropostasLancadas}" varStatus="item">
	                                            ...
	                                            <div class="media-left">
	                                                <a href="${urlImovel}/detalhesImovel/${imovelProposta.imovel.id}" >
	                                                   <span class="meta-provider" style="font-size:19px;">${imovelProposta.imovel.acaoFmt} <br>
	                                                    ...
	                                                    <img src="${context}${imovelProposta.imovel.imagemArquivo}" class="img-responsive" style="width: 260px; height: 240px; alt="admin"/>
	                                                </a>
	                                            </div>
	                                                        ...
	                                                        <tbody style="font-size: 13px;">	                                                        
                                                            	...
                                                            	<tr>
                                                            	 ...
                                                            	 <tr>
	                                                                ...
	                                                                <td class="text-right">${imovelProposta.imovel.quantGaragem} vaga(s)</td>
	                                                            </tr>
