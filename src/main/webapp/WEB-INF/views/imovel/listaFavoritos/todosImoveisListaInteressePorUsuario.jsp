...
<script type="text/javascript">
	...
	function mostrarModal(id){	
		if (id == 0){
			$('#msgModal').html("<spring:message code='lbl.aba.modal.desc.link.todos.imoveis.lista.interesse'/>");		
			$('#msgModalFuncionalidade').html("<spring:message code='lbl.aba.todos.usuarios.lista.interesse'/>");
		}	
		                                            ...
		                                            <c:forEach var="imovelInteresse" items="${listaTodoImoveisFavoritosUsuario}" >
			                                            <tr>
			                                                <td class="text-center">	 
																<a href="${urlImovel}/detalhesImovel/${imovelInteresse.id}" ><img src="data:image/jpeg;base64,${imovelInteresse.imagemArquivo}" style="width: 60px; height: 50px; " /></a>									                     			                				
			                                                </td>			                                                
