								...
								<div class="panel-body">
									<div class="col-lg-7 col-md-8 col-sm-6">
	                                      	<div id="owl-demo" class="owl-carousel owl-theme">                                             
		                                             <div class="item"><img class="responsive" src="data:image/jpeg;base64,${usuarioForm.imagemArquivo}"  style="max-height:395px; height: 320px; width: 470px;"></div>                                            
		                                     </div>
		                				</div>
                            ...
                            <form:form method="POST" id="imovelForm" modelAttribute="imovelForm" action="${urlImovel}/filtrarImoveisPerfilUsuario" >
                                ...
                                <div class="panel rounded shadow no-overflow">                                    
                                    ...
                                    <div class="panel-body">
								        ...
								        <c:choose>
							            	<c:when test="${((usuarioForm.perfil == 'P') && (usuario.perfil != 'P'))}">
							            		<br> <br>
							            		 
							            		<span class="label label-default"><spring:message code="lbl.buscar.imovel.intermediacao"/> </span>
							            	...
							            	<c:when test="${((usuarioForm.perfil != 'P') && (usuario.perfil != 'P'))}">
							            		...
							            		<span class="label label-default"><spring:message code="lbl.buscar.imovel.parceria"/> </span>
									             <spring:message code="lbl.hint.imovel.parceria.intermediacao" var="hintParceriaIntermediaca"/>
										             <form:select id="autorizacaoOutroUsuario" path="autorizacaoOutroUsuario" class="chosen-select" tabindex="-1" style="display: none;" title="${hintParceriaIntermediaca}">            
														<form:option value="" ><spring:message code="opcao.selecao.uma.opcao"/></form:option>                        
														<form:option value="S" ><spring:message code="lbl.sim"/></form:option>                        
                             ...
                             <form:form method="POST" id="imovelForm" modelAttribute="imovelForm" action="${urlImovel}/filtrarImoveisPerfilUsuarioPorCodigoIdentificacao" >
	                             	<div class="panel rounded shadow no-overflow">
	                                	 <div class="panel-body">
		                                	 <br>
                                    ...
                                    <c:forEach var="imovel" items="${listaImoveisPerfilUsuario}" varStatus="item">
                                        <div class="media rounded shadow no-overflow">
                                            ...
                                            <div class="media-left">
                                                <a href="${urlImovel}/detalhesImovel/${imovel.id}" >
                                                   <span class="meta-provider ${imovel.classePorAcao}" style="font-size:19px;">${imovel.acaoFmt} <br>
                                                    ...
                                                    <img src="data:image/jpeg;base64,${imovel.imagemArquivo}" class="img-responsive" style="width: 260px; height: 320px; alt="admin"/>
                                                </a>
                                            </div>
                                            <div class="media-body">                                            	
                                                ...
                                                <div class="col-md-5" >  	                                                
	                                                	<div class="media-body" >
				                                            <em class="text-xs text-muted"> <font style="font-size:13px; font-style: normal;"><spring:message code="lbl.data.ultima.imovel.atualizacao" />: </font><span class="text-success"><font style="font-size:11px; font-style: normal;">
				                                            <br>
