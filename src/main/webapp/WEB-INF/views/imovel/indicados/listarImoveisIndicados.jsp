...
$('#opcaoVisualizacao').change(function () {				
	$("#modoVisualizaIndicadosForm").submit();      
 });
...
function desmarcarCheck(id) {
    $.post("${urlImovelIndicado}/desmarcarCheck", {'idImovelIndicado' : id}, function() {
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                      <h2><i class="fa fa-pencil"></i> 
                    	...
                    	<span><spring:message code="lbl.title.link.imoveis.indicacoes.recebidas"/></span> 
                    </h2>                                                         					
                </div><!-- /.header-content -->
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <div class="row">                  		 
					    ...
					    <div class="col-lg-9 col-md-9 col-sm-8">
					    	<c:choose>
					    		<c:when test="${ empty listarImoveisIndicados }">
					    			<div class="callout callout-warning">
	                                    <strong><spring:message code="msg.erro.nenhuma.indicacao"/></strong>                              
	                                </div>
					    		</c:when>
					    		
					    		<c:when test="${not empty listarImoveisIndicados }">
	                                ...
	                                <div class="pull-right" >	                                
	                                       ...
	                                       <form:form method="POST" id="modoVisualizaIndicadosForm" modelAttribute="imovelIndicadoForm" action="${urlImovelIndicado}/modoVisualizar" >				                           
				                                   <form:select id="opcaoVisualizacao" path="opcaoVisualizacao" class="chosen-select" tabindex="-1" style="display: none;" title="${hintAgrupar}">
	                                ...
	                                <div class="pull-right" style="padding-right:10px; width: 240px;">
	                                		<spring:message code="lbl.hint.tipo.ordenacao" var="hintOrdenar"/>
	                                   			<form:form method="POST" id="indicacaoForm" modelAttribute="imovelIndicadoForm" action="${urlImovelIndicado}/ordenar" >
							              		   <form:hidden  path="tipoLista" value="indicado" />								               
	                                ...
	                                <div class="media-list list-search">
	                                 		<c:forEach var="imovelIndicado" items="${listarImoveisIndicados}" varStatus="item">
	                                            ...
	                                            <div class="media-left">
	                                                <a href="${urlImovel}/detalhesImovel/${imovelIndicado.imovel.id}" >
	                                                   <span class="meta-provider" style="font-size:19px;">${imovelIndicado.imovel.acaoFmt} <br>
	                                                    ...
	                                                    <img src="${context}${imovelIndicado.imovel.imagemArquivo}" class="img-responsive" style="width: 240px; height: 245px; alt="admin"/>
	                                                </a>
	                                            </div>
	                                                ...
	                                                <div class="col-md-5" >                                                    
	                                                 	...
	                                                 	<div class="media-body" >			                                            			                                            
				                                            ...
				                                            <fmt:formatDate value='${imovelIndicado.dataIndicacao}' pattern='dd/MM/yyyy'/> </span></em> </br>
	                                                 		...
	                                                 		<em class="text-sm text-muted" ><font style="font-size:13px; font-style: normal;"><spring:message code="lbl.usuario.indicador" />: </font><span class="text-success"></span></em> </br>
				                                            <a href="${urlUsuario}/detalhesUsuario/${imovelIndicado.usuarioIndicador.id}">
				                                            	<img src="${context}${imovelIndicado.usuarioIndicador.imagemArquivo}" class="img-responsive" style="width: 60px; height: 65px; alt="admin"/>
				                                            </a>			                                            
				                                        </div>
	                                                ...
	                                                <div class="col-md-7">
	                                                        ...
	                                                        <tbody style="font-size: 13px;">	                                                        	
	                                                           ...
	                                                           <tr>
                                                            	...
                                                            	<tr>
	                                                                ...
	                                                                <td class="text-right">${imovelIndicado.imovel.quantGaragem} <spring:message code="lbl.num.vagas"/></td>
	                                                            </tr>
	                                                    ...
	                                                    <br>                                              		
	                                                 	...
	                                                 	<% if ( request.getSession().getAttribute("acessoValido").equals("S") ) {%>
	                                                 			<c:if test="${(imovel.interessadoImovel == 'N') && (imovel.idUsuario != usuario.id)}">
																	<a href="#a" id="idMeInteressei_${imovelIndicado.imovel.id}" onClick="adicionarInteresse(${imovelIndicado.imovel.id})" style="font-size:x-large; color: rgb(99, 110, 123);" class="meta-action"><i class="fa fa-star-o" title="<spring:message code="lbl.me.interessei"/>"> <font style="color: rgb(99, 110, 123); font-size: 12px; margin-bottom:  22px;"> <spring:message code="lbl.me.interessei"/> </font> &nbsp;&nbsp;</i></a>
																</c:if>
																
																<c:if test="${imovel.interessadoImovel == 'S'}">
																	<a href="#a" id="idNovoInteressado_${imovelIndicado.imovel.id}" onClick="retirarInteresse(${imovelIndicado.imovel.id})" style="font-size:x-large; color: rgb(99, 110, 123);" class="meta-action"><i class="fa fa-star" title="<spring:message code="lbl.interessado"/>"> <font style="color: rgb(99, 110, 123); font-size: 12px; margin-bottom:  22px;"> <spring:message code="lbl.interessado"/> </font>&nbsp;&nbsp;</i></a>
																</c:if>
																
																<a href="#a" id="idNovoMeInteressei_${imovelIndicado.imovel.id}" onClick="adicionarInteresse(${imovelIndicado.imovel.id})" style="font-size:x-large; color: rgb(99, 110, 123); display: none;" class="meta-action"><i class="fa fa-star-o"> <font style="color: rgb(99, 110, 123); font-size: 12px; margin-bottom:  22px;"> <spring:message code="lbl.me.interessei"/> </font> &nbsp;&nbsp; </i> </a>
																<a href="#a" id="idInteressado_${imovelIndicado.imovel.id}" onClick="retirarInteresse(${imovelIndicado.imovel.id})" style="font-size:x-large; display: none; color: rgb(99, 110, 123);" class="meta-action"><i class="fa fa-star" > <font style="color: rgb(99, 110, 123); font-size: 12px; margin-bottom:  22px;"> <spring:message code="lbl.interessado"/> </font> &nbsp;&nbsp; </i></a>
