...
<script type="text/javascript">
	...
	function mostrarModal(id){	
		if (id == 0){
			$('#msgModal').html("<spring:message code='lbl.aba.desc.modal.todos.imoveis.indicados'/>");		
			$('#msgModalFuncionalidade').html("<spring:message code='lbl.todos.imoveis.indicados'/>");
		}
		                                ...
		                                <div class="inner-all">
		                                    <ul class="list-unstyled">
		                                        <li class="text-center">	
													<a href="${urlUsuario}/detalhesUsuario/${usuarioIndicado.id}" ><img class="img-circle img-bordered-primary" src="data:image/jpeg;base64,${usuarioIndicado.imagemArquivo}" style="width: 200px; height: 200px; "></a>		                                            
		                                        </li>
		                                        <li class="text-center">
