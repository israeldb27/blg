...
<script type="text/javascript">
	...
	function mostrarModal(id){	
		if (id == 0){
			$('#msgModal').html("<spring:message code='lbl.aba.modal.desc.lista.todas.atividades.imovel'/>");		
			$('#msgModalFuncionalidade').html("<spring:message code='lbl.lista.todas.atividades.imovel'/>");
		}
        ...
        <section id="wrapper">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-pencil"></i><spring:message code="lbl.title.aba.det.imovel.atividades"/> </h2>     
                </div><!-- /.header-content -->                
                   			...
                   			<div class="col-lg-9 col-md-9 col-sm-8">
			                    ...
			                    <div class="divider"></div>	
	                      	   ...
	                      	   <div class="row">
		                      		<div class="panel">
		                      			<c:choose>
											<c:when test="${not empty listaAtividades}">
